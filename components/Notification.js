  ...
  ({ notification, deleteNotification, timeout }) => {
    ...
    return (
      isVisible && (
        <div
          id="toast-default"
          class="mb-3 flex items-center  p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 "
          role="alert"
        >
          ...
          <div class="ml-3 text-sm font-normal">{notification.label}</div>
          <button
            type="button"
