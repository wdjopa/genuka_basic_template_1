...
function ArticleCard({ article }) {
  //   console.log({ article });
  return (
    <div className="bg-white shadow-md rounded-t-lg border border-gray-200 rounded-lg w-full mb-5">
      <Link
        href={"/articles/" + article.slug}
        className="mx-auto w-auto flex items-center rounded-t-lg justify-center"
      >
        <img
          className=" "
